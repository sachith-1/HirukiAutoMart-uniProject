...
<section class="container-fluid" style="margin:30px 5px 60px 5px;;">
    <div class="row">
        ...
        <div class="col-sm-6 text-center">
            <h2 style="font-family: 'Muli', sans-serif;color:#769ff8;">Payment Success!</h2>
            <img src="../images/paySuccess.png" class="img-fluid" style="margin-top:12px;width:35%;" alt="">
            <h5 style="margin-top:10px;font-family: 'Muli', sans-serif;color:#2e4053;">Your Payment was successfull !</h5>
            <br>
