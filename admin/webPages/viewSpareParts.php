...
<head>
    ...
    <title>Hiruki AutoMart | View Spare parts</title>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="viewSpareParts.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">View Spare Parts</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col table-responsive " height="auto">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php
                                    include_once("../../includes/DbConn.php");
                                    $query = "select name,year,brand,price,qty,disc,img1,partID from part;";
                                    $result = mysqli_query($conn, $query);
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        $partID = $row['partID'];
                                        echo "<tr>";
                                        ...
                                        echo "<td>";
                                        echo "<a href='editPart.php?partID=$partID'>Edit</a>";
                                        echo "</td>";
                                        echo "<td>";
                                        $query = "select oderID from oder where partID=$partID";
                                        $rslt = mysqli_query($conn, $query);
                                        $counter = mysqli_num_rows($rslt);
                                        if ($counter <= 0) {

                                            echo "<a href='deletePart.php?partID=$partID'>Delete</a>";
                                        }
                                    }
                                    ?>
