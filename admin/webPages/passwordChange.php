            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="passwordChange.php" class="nav-link active">
                ...
                <div class="container-fluid" height="auto">
                    ...
                    <div class="row" height="auto">
                        <div class="col" height="auto">
                            <form style="margin:0 15%;" method="post" action="../includes/passwordChangeBack.php" enctype="multipart/form-data">
                                ...
                                <!-- Vkey for verfication [customer] -->
                                <input type="hidden" name="vkey" value=<?php echo(isset($_GET["vkey"]) ? $_GET["vkey"] : "") ?>>
                                <!-- Sign up button -->
                            ...
                            if (isset($_GET['alert'])) {
                                ...
                                } else if ($_GET['alert'] == "passwords are not matching") {
                                    echo "<center>passwords are not matching</center>
                                        </div>";
                                }
                            }
                            ?>
