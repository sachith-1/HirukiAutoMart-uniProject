...
<head>
    ...
    <title>Hiruki AutoMart | Spare Parts Oders</title>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="sparePartsOders.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Spare Parts Oders</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col table-responsive " height="auto">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php
                                    include_once("../../includes/DbConn.php");
                                    $query = "select oderID,customer.fname,part.name,paymentID,oder.qty,isPaid from oder inner join part on part.partID=oder.partID inner join customer on oder.custID=customer.custID;";
                                    $result = mysqli_query($conn, $query);
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        echo "<tr>";
                                        echo "<td>";
