...
if(!isset($_SESSION['type']) || empty($_SESSION['type'])){
  header("Location:../login.php");
    ...
    $GLOBALS['query'] = "select name, colour, brand, price, PreOderPrice, carYear, fuelType, milege, period from car where carID='".$carID."'";
    ...
    while ($row = mysqli_fetch_assoc($result)) {
      ...
      $GLOBALS['PreOder-Price'] = $row['PreOderPrice'];
      $GLOBALS['Year'] = $row['carYear'];
      $GLOBALS['Fuel Type'] = $row['fuelType'];
      $GLOBALS['Milege'] = $row['milege'];
      $GLOBALS['Time Period'] = $row['period'];
    }
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="container-fluid" height="auto">
                    ...
                    <div class="row" height="auto">
                        <div class="col" height="auto">
                            <form style="margin:0 15%;" method="post" action="../includes/editCarBack.php" enctype="multipart/form-data">

                                <p class="h4 mb-4 text-center">Car Details</p>

                                
                                <input type="text" name="name" class="form-control mb-4" placeholder="Car Name" value=<?php echo $GLOBALS['Name']; ?>  required>
                                
                                <input type="text" name="price" class="form-control mb-4" placeholder="Price" value=<?php echo $GLOBALS['Price']; ?>  required>
                                
                                <input type="text" name="PreOderPrice" class="form-control mb-4" placeholder="PreOder-Price" value=<?php echo $GLOBALS['PreOder-Price']; ?>  required>                             
                                
                                <input type="text" name="colour" class="form-control mb-4" placeholder="Colour" value=<?php echo $GLOBALS['Colour']; ?>  required>
                                ...
                                <input type="text" name="milege" class="form-control mb-4" placeholder="Milege" value=<?php echo $GLOBALS['Milege']; ?>  required>

                                <input type="text" name="period" class="form-control mb-4" placeholder="Time Period" value=<?php echo $GLOBALS['Time Period']; ?>  required>

                                <input type="text" name="fueltype" class="form-control mb-4" placeholder="Fuel Type" value=<?php echo $GLOBALS['Fuel Type']; ?>  required>
