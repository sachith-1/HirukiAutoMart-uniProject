                ...
                <div class="container-fluid" height="auto">
                    ...
                    <div class="row" height="auto">
                        <div class="col" height="auto">
                            <form style="margin:0 15%;" method="post" action="../includes/addSalsman.php" enctype="multipart/form-data">

                                <p class="h4 mb-4 text-center">New Salesman</p>
                                <div class="row ">
                                    <?php
                                ...
                                <!-- NIC number -->
                                <input type="text" name="nic" class="form-control mb-4" placeholder="NIC">
