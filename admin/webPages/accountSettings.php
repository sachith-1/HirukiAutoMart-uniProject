...
if ($_SESSION['type'] == "Salesman") {
    $GLOBALS['query'] = "select fname, lname, address, phone from salesman where email='" . $email . "'";
} else if ($_SESSION['type'] == "Owner") {
    $GLOBALS['query'] = "select fname, lname, address, phone from owner where email='" . $email . "'";
}
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="#" target="blank" class="nav-link active">
                ...
                <div class="container-fluid" height="auto">
                    ...
                    <div class="row" height="auto">
                        <div class="col" height="auto">
                            <form style="margin:0 15%;" method="post" action="../includes/accountSettingsBack.php" enctype="multipart/form-data">

                                <p class="h4 mb-4 text-center">Account Details</p>

                                <!-- First Name -->
                                <input type="text" name="fname" class="form-control mb-4" placeholder="First Name" value=<?php echo $GLOBALS['fname']; ?> required>
                                <!--Last Name-->
                                <input type="text" name="lname" class="form-control mb-4" placeholder="Last Name" value=<?php echo $GLOBALS['lname']; ?> required>
                                <!-- address -->
                                <input type="text" name="address" class="form-control mb-4" placeholder="Address" value=<?php echo $GLOBALS['address']; ?> required>
                                <!-- phone -->
                                <input type="text" name="phone" class="form-control mb-4" placeholder="Phone Number" value=<?php echo $GLOBALS['phone']; ?> required>
