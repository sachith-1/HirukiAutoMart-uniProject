                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="removeCustomer.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Remove Customer</p>
                                    </a>
                                </li>
                ...
                <div class="container-fluid" height="auto">
                    <div class="row" height="auto">
                        <div class="col text-center">
                            <p class="h4 mb-4" style="color:#E81123;">Remove Customer</p>

                            <form style="margin:5% 15%;" class="text-center" method="post" action="../includes/removeCustomerback.php">
                                <input type="text" class="form-control mb-4" name="id" placeholder="Customer ID">
                            ...
                            if (isset($_GET['remove'])) {
                                ...
                                if ($_GET['remove'] == "success") {
                                    ...
                                    echo "<center>No customer found with the entered ID</center>
                                    </div>";
                                }
                            }
                            ?>
