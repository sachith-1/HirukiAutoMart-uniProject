                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="addSparePart.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add Spare Part</p>
                                    </a>
                                </li>
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Add Spare-Part</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="container-fluid" height="auto">
                    ...
                    <div class="row" height="auto">
                        <div class="col" height="auto">
                            <form style="margin:0 15%;" method="post" action="../includes/addpartsBack.php" enctype="multipart/form-data">

                                <p class="h4 mb-4 text-center">New Spare-Part</p>

                                <!-- Product Name -->
                                <input type="text" name="productName" class="form-control mb-4" placeholder="Product Name">
                                <!--price-->
                                <input type="text" name="price" class="form-control mb-4" placeholder="Price">
                                <!--brand-->
                                <input type="text" name="brand" class="form-control mb-4" placeholder="Brand">
                                <!-- year -->
                                <input type="text" name="year" class="form-control mb-4" placeholder="Year">
                                <!-- qty -->
                                <input type="text" name="qty" class="form-control mb-4" placeholder="Quantity">
                                ...
                                <div class="input-group mb-4" style="max-width:490px;">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" id="img1" name="img1" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
                                ...
                                <div class="input-group mb-4" style="max-width:490px;">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" id="img2" name="img2" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
                                        <label class="custom-file-label" for="inputGroupFile01">Choose file</label>
                                    </div>
                                </div>
                                <div class="input-group mb-4" style="max-width:490px;">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" id="img3" name="img3" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
                                        <label class="custom-file-label" for="inputGroupFile01">Choose file</label>
                                    </div>
                                </div>
                                <div class="input-group mb-4" style="max-width:490px;">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" id="img4" name="img4" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01">
                                        <label class="custom-file-label" for="inputGroupFile01">Choose file</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="mb-3">
                                        <textarea id="desc" name="desc" class="textarea" placeholder="Brief Discription About Spare-part" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                    </div>
                                </div>
