...
<head>
    ...
    <title>Hiruki AutoMart | View Cars</title>
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="viewCars.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>View Cars</p>
                                    </a>
                                </li>
    ...
    if (isset($_GET['alert'])) {
                                    ...
                                    if ($_GET['alert'] == "success") {
                                        echo "<center>Details were updated</center>
                                        </div>";
                                    } 
                            ...
                            <div class="col table-responsive " height="auto">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                        include_once("../../includes/DbConn.php");
                                        $query = "select name,price,PreOderPrice,colour,brand,img1,carYear,milege,period,fuelType,carID from car;";
                                        $result = mysqli_query($conn, $query);
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            $carID=$row['carID'];
                                            echo "<tr>";
                                            ...
                                            echo "</td>";
                                            echo "<td>";
                                            echo "<img src='../../images/vehicles/" . $row['img1'] . "' alt='range Rover' style='width: 60px;height:auto;'>";
                                            echo "</td>";
                                            echo "<td>";
                                            echo $row['carYear'];
                                            echo "</td>";
                                            ...
                                            echo "</td>";
                                            echo "<td>";
                                            echo "<a href='editCar.php?carID=$carID'>Edit</a>";
                                            echo "</td>";
                                            echo "<td>";
                                            $query="select preoderID from preoder where carID=$carID";
                                            $rslt=mysqli_query($conn,$query);
                                            $counter=mysqli_num_rows($rslt);
                                            if($counter<=0){
                                                $query="select tdriveID from testdrive where carID=$carID";
                                                $r1=mysqli_query($conn,$query);
                                                $c1=mysqli_num_rows($r1);
                                                if($c1<=0){
                                                    echo "<a href='deleteCar.php?carID=$carID'>Delete</a>";
                                                }
